        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        <img src={`https://i.pravatar.cc/150?img=${id}`} className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">
                    ...
                    <div className="flex flex-col text-black">
                        <span className="text-gray-700 uppercase font-bold tracking-wider mb-2">Contact Info</span>
                        <ul>
                            <li className="mb-2">Email - {userInfo?.email}</li>
                            <li className="mb-2">Phone - {userInfo?.phone}</li>
                            <li className="mb-2">City - {userInfo?.address?.city}</li>
                            <li className="mb-2">Street - {userInfo?.address?.street}</li>
                            <li className="mb-2">Suite - {userInfo?.address?.suite}</li>
                            <li className="mb-2">Company - {userInfo?.company?.name}</li>
                            <li className="mb-2">Website - {userInfo?.website}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className="col-span-4 sm:col-span-9">
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <h2 className="text-xl font-bold mt-6 mb-4 text-black">Experience</h2>
